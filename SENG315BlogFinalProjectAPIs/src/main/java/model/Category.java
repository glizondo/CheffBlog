...
public class Category {
	...
	public JSONArray listCategories() {
		...
		String sqlString = "SELECT * " + "FROM " + mssqlConnection.getDatabase() + ".dbo.categories WITH (NOLOCK) "
	...
	public String updateCategory() {
		...
		try {
			...
			String update = "UPDATE " + mssqlConnection.getDatabase() + ".dbo.categories SET "
					...
					+ " categoryContent=IsNull(?,categoryContent), categoryOrder=IsNull(?,categoryOrder), categoryVisible=IsNull(?,categoryVisible) "
					+ "WHERE categoryID=" + categoryID + "";
	...
	public String deleteCategory() {
		...
		try {
			...
			String delete = "DELETE FROM " + mssqlConnection.getDatabase() + ".dbo.categories " + "WHERE categoryID="
					+ categoryID;
