...
public class Navigation {
	...
	public JSONArray listNavigations() {
		...
		String sqlString = "SELECT * " + "FROM " + mssqlConnection.getDatabase() + ".dbo.navigations WITH (NOLOCK) "
	...
	public String deleteNavigation() {
		...
		try {
			...
			String delete = "DELETE FROM " + mssqlConnection.getDatabase() + ".dbo.navigations " + "WHERE navigationID="
					+ navigationID;
