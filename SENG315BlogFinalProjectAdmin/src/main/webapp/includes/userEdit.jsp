...
<div class="form-group col-xs-12 col-md-12">
    <label for="userImage">Profile photo</label>
    <input type="text" class="form-control" id="userImage" autofocus required>
</div>
<div class="form-group col-xs-12 col-md-12">
 ...
 <span>
     <button class="btn btn-primary"  type="submit" onclick="updateUser()" data-toggle="tooltip" title="Update User">Update User</button>
 </span>
